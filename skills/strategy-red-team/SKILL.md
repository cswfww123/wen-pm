...
description: Use when the user explicitly requests a strategy red-team, or pm-alignment routes a settled plan for load-bearing-assumption attack before Bet or further discovery.
---
